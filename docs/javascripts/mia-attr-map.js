...
(function (root) {
  ...
  var COLLECTIONS = [
    ...
    ["caracs", "caracs"],
    // LE BONUS de chaque caractéristique (réglé sur la fiche) et les TROIS
    // LEVIERS du meneur, qui décalent ce qu'elle donne sans toucher la valeur.
