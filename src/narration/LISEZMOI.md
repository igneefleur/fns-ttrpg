...
1. Le fichier servi ne s'édite plus. On modifie un morceau, puis on
   réassemble. `scripts/release_fiche.py` réassemble de lui-même avant de
   publier, et refuse une source en avance sur le fichier servi.
