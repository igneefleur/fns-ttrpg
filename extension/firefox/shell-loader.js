 ...
 * vient la page distante. Une balise <script src> écrite en dur dans ces pages
 * interdirait tout choix à l'exécution ; ce fichier est là pour ça, et pour
 * rien d'autre.
 *
 ...
 * seconde course, et l'onglet pourrait annoncer « Fiche Outward beta » avec la
 * fiche stable dedans si le mode basculait entre les deux lectures. Ici, la
 * copie qui a construit l'adresse dicte la coquille, et il n'y a plus rien à
 * accorder.
 *
 * Tout mode absent ou inconnu vaut stable : une page d'extension ouverte à la
 * main doit montrer la fiche publiée, jamais celle de la beta.
 *
...
(function () {
  ...
  // fond serait toujours celui du jour : un éclair clair à chaque ouverture de
  // fiche ou de panneau au milieu d'une partie sombre. Le n=1/0 du hash dit
  ...
  // [#&] en tête : le paramètre peut être le premier du hash ou suivre un « & ».
  // (?:&|$) en queue : sans elle, un « m=betaX » passerait pour la beta.
