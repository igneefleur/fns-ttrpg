  ...
  function placeTabs() {
    ...
    labelEls("Feuille de personnage").forEach(function (feuille) {
      ...
      function showOurPane() {
        ...
        pane.classList.add("hxh-on");   // seule cette classe rend le pane visible (overlay.css)
      ...
      function hideOurPane() { pane.style.display = "none"; pane.classList.remove("hxh-on"); tab.classList.remove("active"); }
